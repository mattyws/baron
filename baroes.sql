...
--
-- Host: localhost
-- Tempo de geração: 23/02/2015 às 23:11
...
--
-- Banco de dados: `baroes`
--

-- --------------------------------------------------------

--
-- Estrutura para tabela `core_settings`
--
...
--
-- Fazendo dump de dados para tabela `core_settings`
--
...
--
-- Estrutura para tabela `core_sites`
--
...
--
-- Fazendo dump de dados para tabela `core_sites`
--

INSERT INTO `core_sites` (`id`, `name`, `ref`, `domain`, `active`, `created_on`, `updated_on`) VALUES
(1, 'Default Site', 'default', 'localhost', 1, 1424732623, 0);

-- --------------------------------------------------------

--
-- Estrutura para tabela `core_users`
--
...
--
-- Fazendo dump de dados para tabela `core_users`
--
...
(1, 'default@master.com', '513b6f71fb6626d6bdc79ca7b67c57b21852c216', 'd8293', 1, '', 1, '', 1424732618, 1424732618, 'default', NULL, NULL);

-- --------------------------------------------------------

--
-- Estrutura para tabela `default_blog`
--
...
--
-- Estrutura para tabela `default_blog_categories`
--
...
--
-- Estrutura para tabela `default_ci_sessions`
--
...
--
-- Fazendo dump de dados para tabela `default_ci_sessions`
--

INSERT INTO `default_ci_sessions` (`session_id`, `ip_address`, `user_agent`, `last_activity`, `user_data`) VALUES
('93271aaf73f2cec8dcbdc98de8e13cf7', '::1', 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.115 Safari/537.36', 1424733040, 'a:6:{s:8:"username";s:7:"default";s:5:"email";s:18:"default@master.com";s:2:"id";s:1:"1";s:7:"user_id";s:1:"1";s:8:"group_id";s:1:"1";s:5:"group";s:5:"admin";}');

-- --------------------------------------------------------

--
-- Estrutura para tabela `default_comments`
--
...
--
-- Estrutura para tabela `default_comment_blacklists`
--
...
--
-- Estrutura para tabela `default_contact_log`
--
...
--
-- Estrutura para tabela `default_data_fields`
--
...
--
-- Fazendo dump de dados para tabela `default_data_fields`
--
...
--
-- Estrutura para tabela `default_data_field_assignments`
--
...
--
-- Fazendo dump de dados para tabela `default_data_field_assignments`
--
...
--
-- Estrutura para tabela `default_data_streams`
--
...
--
-- Fazendo dump de dados para tabela `default_data_streams`
--
...
--
-- Estrutura para tabela `default_def_page_fields`
--
...
--
-- Fazendo dump de dados para tabela `default_def_page_fields`
--

INSERT INTO `default_def_page_fields` (`id`, `created`, `updated`, `created_by`, `ordering_count`, `body`) VALUES
(1, '2015-02-23 23:03:56', NULL, 1, NULL, '<p>Welcome to our homepage. We have not quite finished setting up our website yet, but please add us to your bookmarks and come back soon.</p>'),
(2, '2015-02-23 23:03:56', NULL, 1, NULL, '<p>To contact us please fill out the form below.</p>\n				{{ contact:form name="text|required" email="text|required|valid_email" subject="dropdown|Support|Sales|Feedback|Other" message="textarea" attachment="file|zip" }}\n					<div><label for="name">Name:</label>{{ name }}</div>\n					<div><label for="email">Email:</label>{{ email }}</div>\n					<div><label for="subject">Subject:</label>{{ subject }}</div>\n					<div><label for="message">Message:</label>{{ message }}</div>\n					<div><label for="attachment">Attach  a zip file:</label>{{ attachment }}</div>\n				{{ /contact:form }}'),
(3, '2015-02-23 23:03:56', NULL, 1, NULL, '{{ search:form class="search-form" }} \n		<input name="q" placeholder="Search terms..." />\n	{{ /search:form }}'),
(4, '2015-02-23 23:03:56', NULL, 1, NULL, '{{ search:form class="search-form" }} \n		<input name="q" placeholder="Search terms..." />\n	{{ /search:form }}\n\n{{ search:results }}\n\n	{{ total }} results for "{{ query }}".\n\n	<hr />\n\n	{{ entries }}\n\n		<article>\n			<h4>{{ singular }}: <a href="{{ url }}">{{ title }}</a></h4>\n			<p>{{ description }}</p>\n		</article>\n\n	{{ /entries }}\n\n        {{ pagination }}\n\n{{ /search:results }}'),
(5, '2015-02-23 23:03:56', NULL, 1, NULL, '<p>We cannot find the page you are looking for, please click <a title="Home" href="{{ pages:url id=''1'' }}">here</a> to go to the homepage.</p>');

-- --------------------------------------------------------

--
-- Estrutura para tabela `default_email_templates`
--
...
--
-- Fazendo dump de dados para tabela `default_email_templates`
--
...
--
-- Estrutura para tabela `default_files`
--
...
--
-- Estrutura para tabela `default_file_folders`
--
...
--
-- Estrutura para tabela `default_groups`
--
...
--
-- Fazendo dump de dados para tabela `default_groups`
--
...
--
-- Estrutura para tabela `default_keywords`
--
...
--
-- Estrutura para tabela `default_keywords_applied`
--
...
--
-- Estrutura para tabela `default_migrations`
--
...
--
-- Fazendo dump de dados para tabela `default_migrations`
--
...
--
-- Estrutura para tabela `default_modules`
--
...
--
-- Fazendo dump de dados para tabela `default_modules`
--
...
--
-- Estrutura para tabela `default_navigation_groups`
--
...
--
-- Fazendo dump de dados para tabela `default_navigation_groups`
--
...
--
-- Estrutura para tabela `default_navigation_links`
--
...
--
-- Fazendo dump de dados para tabela `default_navigation_links`
--
...
--
-- Estrutura para tabela `default_pages`
--
...
--
-- Fazendo dump de dados para tabela `default_pages`
--
...
(1, 'home', '', 'Home', 'home', 0, '1', '1', NULL, NULL, NULL, '', NULL, NULL, NULL, 0, 0, 'live', 1424732640, 0, '', 1, 1, 1424732640),
(2, 'contact', '', 'Contact', 'contact', 0, '1', '2', NULL, NULL, NULL, '', NULL, NULL, NULL, 0, 0, 'live', 1424732640, 0, '', 0, 1, 1424732640),
(3, 'search', '', 'Search', 'search', 0, '1', '3', NULL, NULL, NULL, '', NULL, NULL, NULL, 0, 0, 'live', 1424732640, 0, '', 0, 1, 1424732640),
(4, 'results', '', 'Results', 'search/results', 3, '1', '4', NULL, NULL, NULL, '', NULL, NULL, NULL, 0, 0, 'live', 1424732640, 0, '', 0, 0, 1424732640),
(5, '404', '', 'Page missing', '404', 0, '1', '5', NULL, NULL, NULL, '', NULL, NULL, NULL, 0, 0, 'live', 1424732640, 0, '', 0, 1, 1424732640);

-- --------------------------------------------------------

--
-- Estrutura para tabela `default_page_types`
--
...
--
-- Fazendo dump de dados para tabela `default_page_types`
--
...
--
-- Estrutura para tabela `default_profiles`
--
...
--
-- Fazendo dump de dados para tabela `default_profiles`
--
...
(1, NULL, NULL, NULL, NULL, 1, 'default master', 'default', 'master', '', 'en', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Estrutura para tabela `default_redirects`
--
...
--
-- Estrutura para tabela `default_search_index`
--
...
--
-- Fazendo dump de dados para tabela `default_search_index`
--
...
--
-- Estrutura para tabela `default_settings`
--
...
--
-- Fazendo dump de dados para tabela `default_settings`
--
...
('contact_email', 'Contact E-mail', 'All e-mails from users, guests and the site will go to this e-mail address.', 'text', 'default@master.com', '', '', 1, 1, 'email', 979),
...
--
-- Estrutura para tabela `default_theme_options`
--
...
--
-- Fazendo dump de dados para tabela `default_theme_options`
--
...
--
-- Estrutura para tabela `default_users`
--
...
--
-- Fazendo dump de dados para tabela `default_users`
--
...
(1, 'default@master.com', '513b6f71fb6626d6bdc79ca7b67c57b21852c216', 'd8293', 1, '', 1, '', 1424732618, 1424733048, 'default', NULL, NULL);

-- --------------------------------------------------------

--
-- Estrutura para tabela `default_variables`
--
...
--
-- Estrutura para tabela `default_widgets`
--
...
--
-- Estrutura para tabela `default_widget_areas`
--
...
--
-- Fazendo dump de dados para tabela `default_widget_areas`
--
...
--
-- Estrutura para tabela `default_widget_instances`
--
...
--
-- Índices de tabela `core_users`
--
ALTER TABLE `core_users`
  ADD PRIMARY KEY (`id`), ADD KEY `email` (`email`);

--
-- Índices de tabela `default_blog`
--
ALTER TABLE `default_blog`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `default_blog_categories`
--
...
--
-- Índices de tabela `default_settings`
--
ALTER TABLE `default_settings`
  ADD PRIMARY KEY (`slug`), ADD UNIQUE KEY `unique_slug` (`slug`), ADD KEY `slug` (`slug`);

--
-- Índices de tabela `default_theme_options`
--
ALTER TABLE `default_theme_options`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `default_users`
--
ALTER TABLE `default_users`
  ADD PRIMARY KEY (`id`), ADD KEY `email` (`email`);

--
-- Índices de tabela `default_variables`
--
ALTER TABLE `default_variables`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `default_widgets`
--
ALTER TABLE `default_widgets`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `default_widget_areas`
--
ALTER TABLE `default_widget_areas`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `default_widget_instances`
--
...
--
-- AUTO_INCREMENT de tabela `core_sites`
--
ALTER TABLE `core_sites`
  MODIFY `id` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de tabela `core_users`
--
ALTER TABLE `core_users`
  MODIFY `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de tabela `default_blog`
--
ALTER TABLE `default_blog`
  MODIFY `id` int(9) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de tabela `default_blog_categories`
--
ALTER TABLE `default_blog_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de tabela `default_comments`
--
ALTER TABLE `default_comments`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de tabela `default_comment_blacklists`
--
ALTER TABLE `default_comment_blacklists`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de tabela `default_contact_log`
--
ALTER TABLE `default_contact_log`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de tabela `default_data_fields`
--
ALTER TABLE `default_data_fields`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=17;
--
-- AUTO_INCREMENT de tabela `default_data_field_assignments`
--
ALTER TABLE `default_data_field_assignments`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=17;
--
-- AUTO_INCREMENT de tabela `default_data_streams`
--
ALTER TABLE `default_data_streams`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT de tabela `default_def_page_fields`
--
ALTER TABLE `default_def_page_fields`
  MODIFY `id` int(9) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT de tabela `default_email_templates`
--
ALTER TABLE `default_email_templates`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT de tabela `default_file_folders`
--
ALTER TABLE `default_file_folders`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de tabela `default_groups`
--
ALTER TABLE `default_groups`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT de tabela `default_keywords`
--
ALTER TABLE `default_keywords`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de tabela `default_keywords_applied`
--
ALTER TABLE `default_keywords_applied`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de tabela `default_modules`
--
ALTER TABLE `default_modules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=22;
--
-- AUTO_INCREMENT de tabela `default_navigation_groups`
--
ALTER TABLE `default_navigation_groups`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT de tabela `default_navigation_links`
--
ALTER TABLE `default_navigation_links`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT de tabela `default_pages`
--
ALTER TABLE `default_pages`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT de tabela `default_page_types`
--
ALTER TABLE `default_page_types`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de tabela `default_permissions`
--
ALTER TABLE `default_permissions`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de tabela `default_profiles`
--
ALTER TABLE `default_profiles`
  MODIFY `id` int(9) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de tabela `default_redirects`
--
ALTER TABLE `default_redirects`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de tabela `default_search_index`
--
ALTER TABLE `default_search_index`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT de tabela `default_theme_options`
--
ALTER TABLE `default_theme_options`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT de tabela `default_users`
--
ALTER TABLE `default_users`
  MODIFY `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de tabela `default_variables`
--
ALTER TABLE `default_variables`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de tabela `default_widgets`
--
ALTER TABLE `default_widgets`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de tabela `default_widget_areas`
--
ALTER TABLE `default_widget_areas`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de tabela `default_widget_instances`
--
ALTER TABLE `default_widget_instances`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
